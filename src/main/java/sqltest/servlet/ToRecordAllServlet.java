...
@WebServlet(name = "toRecordAllServlet", value = "/toRecordAll-servlet")
public class ToRecordAllServlet extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String sql="SELECT * FROM sqltest.order";
            ...
            req.getRequestDispatcher("WEB-INF/recordT.jsp").forward(req,resp);
